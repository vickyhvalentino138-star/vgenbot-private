...
async function startBot() {
    ...
    sock.ev.on('connection.update', async (update) => {
        ...
        if (connection === 'close') {
            ...
            // 🔥 BANNER RGB MECHANICAL KEYBOARD (SETIAP HURUF BEDA WARNA + GRADASI FULL 20++ WARNA)
...
\x1b[1m\x1b[38;5;124m  ╰\x1b[38;5;124m─\x1b[38;5;161m─\x1b[38;5;198m─\x1b[38;5;201m─\x1b[38;5;165m─\x1b[38;5;129m─\x1b[38;5;93m─\x1b[38;5;27m─\x1b[38;5;39m─\x1b[38;5;51m─\x1b[38;5;50m─\x1b[38;5;46m─\x1b[38;5;82m─\x1b[38;5;154m─\x1b[38;5;226m─\x1b[38;5;220m─\x1b[38;5;214m─\x1b[38;5;208m─\x1b[38;5;202m─\x1b[38;5;196m─\x1b[38;5;197m─\x1b[38;5;198m─\x1b[38;5;199m─\x1b[38;5;200m─\x1b[38;5;201m─\x1b[38;5;165m─\x1b[38;5;129m─\x1b[38;5;93m─\x1b[38;5;57m─\x1b[38;5;21m─\x1b[38;5;27m─\x1b[38;5;33m─\x1b[38;5;39m─\x1b[38;5;45m─\x1b[38;5;51m─\x1b[38;5;50m─\x1b[38;5;49m─\x1b[38;5;48m─\x1b[38;5;47m─\x1b[38;5;46m─\x1b[38;5;82m─\x1b[38;5;118m─\x1b[38;5;154m─\x1b[38;5;190m─\x1b[38;5;226m─\x1b[38;5;220m─\x1b[38;5;214m─\x1b[38;5;208m─\x1b[38;5;202m─\x1b[38;5;196m─\x1b[38;5;196m╯\x1b[0m`);
            ...
            console.log(`     \x1b[1m\x1b[38;5;196m✦\x1b[38;5;202m \x1b[38;5;208mP\x1b[38;5;214mR\x1b[38;5;220mE\x1b[38;5;226mM\x1b[38;5;190mI\x1b[38;5;154mU\x1b[38;5;118mM\x1b[38;5;82m \x1b[38;5;46mE\x1b[38;5;47mN\x1b[38;5;48mT\x1b[38;5;49mE\x1b[38;5;50mR\x1b[38;5;51mP\x1b[38;5;45mR\x1b[38;5;39mI\x1b[38;5;33mS\x1b[38;5;27mE\x1b[38;5;21m \x1b[38;5;57mE\x1b[38;5;93mD\x1b[38;5;129mI\x1b[38;5;165mT\x1b[38;5;201mI\x1b[38;5;198mO\x1b[38;5;161mN\x1b[38;5;124m \x1b[38;5;88m✦\x1b[0m \x1b[1m\x1b[38;5;82m[\x1b[38;5;118m C\x1b[38;5;154mO\x1b[38;5;190mR\x1b[38;5;226mE\x1b[38;5;220m \x1b[38;5;214mO\x1b[38;5;208mN\x1b[38;5;202mL\x1b[38;5;196mI\x1b[38;5;160mN\x1b[38;5;124mE\x1b[38;5;88m ]\x1b[0m\n`);
        }
   });
    ...
    sock.ev.on('messages.upsert', async (m) => {
        ...
        let isAudio = false; // Deteksi Voice Note
            ...
            try {
                const paramJson = JSON.parse(realMsg.interactiveResponseMessage.nativeFlowResponseMessage?.paramsJson || "{}");
                if (paramJson.id === 'btn_mute') pesanTeks = 'matikan respon ai';
                else if (paramJson.id === 'btn_unmute') pesanTeks = 'aktifkan respon ai';
            } catch (e) {}
        }
        else if (type === 'templateButtonReplyMessage') {
            pesanTeks = realMsg.templateButtonReplyMessage.selectedDisplayText || '';
        }


        const bodyTrimmed = pesanTeks.toLowerCase().trim();
        const isCmd = bodyTrimmed.startsWith('.') || bodyTrimmed.startsWith('!') || bodyTrimmed.startsWith('/') || bodyTrimmed === 'matikan respon ai' || bodyTrimmed === 'aktifkan respon ai';

        // 🔥 BLOKIR PESAN SENDIRI BIAR GAK MASUK LOG INCOMING!
        if (msg.key.fromMe && !isCmd) return;

        // 🔥 KOTAK TUMPUL PREMIUM LOG CHAT MASUK (TABEL PENDEK ELEGAN)
        if (pesanTeks !== '') {
            const targetChat = from.split('@')[0].split(':')[0];
            const timeNow = new Date().toLocaleString('id-ID', { timeZone: 'Asia/Jakarta' });
            console.log(`\n\x1b[38;5;93m╭────────────────────────────────────────╮\x1b[0m`);
            console.log(`\x1b[38;5;129m│\x1b[0m \x1b[1m\x1b[38;5;51m✨ [INCOMING TRANSMISSION]\x1b[0m             \x1b[38;5;129m│\x1b[0m`);
            console.log(`\x1b[38;5;135m│\x1b[0m \x1b[38;5;213m📅 Tanggal  :\x1b[0m \x1b[38;5;253m${timeNow.padEnd(23, ' ')}\x1b[38;5;135m│\x1b[0m`);
            console.log(`\x1b[38;5;141m│\x1b[0m \x1b[38;5;159m👤 Pengirim :\x1b[0m \x1b[1m\x1b[38;5;226m${pushname} (${nomorRapi})\x1b[0m`); 
            console.log(`\x1b[38;5;147m│\x1b[0m \x1b[38;5;220m🏠 Ruang    :\x1b[0m \x1b[1m\x1b[38;5;118m+${targetChat}\x1b[0m`); 
            console.log(`\x1b[38;5;153m│\x1b[0m \x1b[38;5;111m🏓 Tipe     :\x1b[0m \x1b[38;5;87m${type.replace('Message', '')}\x1b[0m`);
            console.log(`\x1b[38;5;159m│\x1b[0m \x1b[38;5;198m💬 Pesan    :\x1b[0m \x1b[38;5;231m${pesanTeks.substring(0, 25)}${pesanTeks.length > 25 ? '...' : ''}\x1b[0m`);
            console.log(`\x1b[38;5;87m╰────────────────────────────────────────╯\x1b[0m`);
        }
        ...
        // =========================================================================
        // 🔒 KONTROL MUTE INTERAKTIF (PUBLIK + TOMBOL NATIVE FLOW + UI PREMIUM)
        // =========================================================================
        global.lastActionTime = global.lastActionTime || {};

        const isMuteCmd = bodyTrimmed.startsWith('/mute') || bodyTrimmed.startsWith('.mute') || bodyTrimmed.startsWith('!mute') || bodyTrimmed === 'matikan respon ai';
        ...
        if (isMuteCmd || isUnmuteCmd) {
            ...
            // 🔥 UI TABEL TUMPUL PREMIUM (KHUSUS CEK STATUS SAJA!)

            if (isMuteCmd) {
                if (aiMutedChats[targetMute]) {
                    // KALO NGECEK STATUS: MUNCUL TABEL + JAM
                    const lastTime = global.lastActionTime[targetMute] || "Belum diketahui";
                    statusText = `Respon AI sudah dalam keadaan mati untuk obrolan ini.\n🕒 *Terakhir Dinonaktifkan:* ${lastTime}`;
                } else {
                    aiMutedChats[targetMute] = true;
                    global.lastActionTime[targetMute] = currentTime;
                    delete userHistory[targetMute]; 
                    statusText = `*Respon AI berhasil dimatikan.*`;
                }
                footerText = "Aktifkan kembali kapan saja"; 
            } else if (isUnmuteCmd) {
                if (!aiMutedChats[targetMute]) {
                    const lastTime = global.lastActionTime[targetMute] || "Belum diketahui";
                    // Teks di bawah ini yang disamain strukturnya
                    statusText = `Respon AI sudah dalam keadaan aktif untuk obrolan ini.\n🕒 *Terakhir Diaktifkan:* ${lastTime}`;
                } else {                
                    delete aiMutedChats[targetMute];
                    global.lastActionTime[targetMute] = currentTime;
                    statusText = `*Respon AI berhasil diaktifkan kembali.*`;
                }
                footerText = "Matikan kembali kapan saja"; 
            }
            ...
            // 🔥 QUOTE KONTAK PREMIUM + CENTANG BIRU MUTLAK (USERNAME MEREKA NONGOL DISINI!)
            const fakeVerifikasiWA_Mute = {
                ...
                message: {
                    contactMessage: {
                        ...
                        vcard: `BEGIN:VCARD\nVERSION:3.0\nN:;${pushname};;;\nFN:${pushname}\nTEL;type=CELL;type=VOICE;waid=${pengirimRaw}:+${pengirimRaw}\nEND:VCARD`
                    }
                }
            };
                ...
                let targetMsg = hasMedia ? realMsg[type] : (quotedMediaMsg ? quotedMediaMsg[Object.keys(quotedMediaMsg)[0]] : null);
                 ...
                 if (activeProvider === 'OPENAI') {
                    ...
                    if (data.candidates) aiResponse = data.candidates[0].content.parts[0].text;
                       ...
                       // 🔥 KOTAK TUMPUL PREMIUM LOG BALASAN AI (CYAN/GREEN PRISMATIC)
                        const responPotong = rawResponse.replace(/\n/g, ' ').length > 35 ? rawResponse.replace(/\n/g, ' ').substring(0, 35) + '...' : rawResponse.replace(/\n/g, ' ');
                        console.log(`\x1b[38;5;46m╭────────────────────────────────────────╮\x1b[0m`);
                        console.log(`\x1b[38;5;47m│\x1b[0m \x1b[1m\x1b[38;5;51m🤖 VGen AI :\x1b[0m \x1b[38;5;231m${responPotong}\x1b[0m`);
                        console.log(`\x1b[38;5;48m╰────────────────────────────────────────╯\x1b[0m\n`);
...
app.post('/deploy-key', (req, res) => {
    ...
    saveDb();
        ...
        // 🔥 TABEL MEMBULAT PRISMATIC SAAT API AKTIF (SUPER PREMIUM)
    const deployTime = new Date().toLocaleString('id-ID', { timeZone: 'Asia/Jakarta' });
    console.log(`\n\x1b[38;5;213m╭────────────────────────────────────────╮\x1b[0m`);
    console.log(`\x1b[38;5;207m│\x1b[0m \x1b[1m\x1b[38;5;226m🚀 VGEN AI : ACTIVE & DEPLOYED!\x1b[0m        \x1b[38;5;207m│\x1b[0m`);
    console.log(`\x1b[38;5;201m├────────────────────────────────────────┤\x1b[0m`);
    console.log(`\x1b[38;5;195m│\x1b[0m \x1b[38;5;123m⌛ Waktu    :\x1b[0m \x1b[38;5;255m${deployTime.padEnd(22, ' ')}\x1b[38;5;195m│\x1b[0m`);
    console.log(`\x1b[38;5;189m│\x1b[0m \x1b[38;5;159m🧠 Provider :\x1b[0m \x1b[1m\x1b[38;5;82m${activeProvider.padEnd(22, ' ')}\x1b[0m\x1b[38;5;189m│\x1b[0m`);
    console.log(`\x1b[38;5;183m│\x1b[0m \x1b[38;5;117m📌 Model    :\x1b[0m \x1b[1m\x1b[38;5;213m${activeModel.padEnd(22, ' ')}\x1b[0m\x1b[38;5;183m│\x1b[0m`);
    console.log(`\x1b[38;5;177m│\x1b[0m \x1b[38;5;85m✅ Status   :\x1b[0m \x1b[1m\x1b[38;5;51m${"ONLINE & TERVERIFIKASI".padEnd(22, ' ')}\x1b[0m\x1b[38;5;177m│\x1b[0m`);
    console.log(`\x1b[38;5;171m╰────────────────────────────────────────╯\x1b[0m\n`);
